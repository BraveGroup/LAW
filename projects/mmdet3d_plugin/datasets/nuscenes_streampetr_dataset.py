...
class CustomNuScenesDataset(NuScenesDataset):
    ...
    def __init__(self, collect_keys, seq_mode=False, seq_length=3, seq_split_num=1, num_frame_losses=1, queue_length=8, random_length=0, *args, **kwargs):
